...
public class App {
    public static void main(String[] args) {
        ...
        System.out.print("How many people? "); int people = in.nextInt();
        System.out.print("How many pizzas do you have? "); int pizza = in.nextInt();
        System.out.print("How many slices per pizza? "); int slice = in.nextInt();
        ...
        System.out.println("There are " + ((pizza * slice) - (people * 2)) + " leftover pieces.");
    }
}
